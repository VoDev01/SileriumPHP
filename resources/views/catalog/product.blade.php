        ...
        <div>
            @if ($product->images != null)
                @if (count($product->images) === 1)
                    <img src="{{ $product->images[0] }}" alt="Картинка товара 1" width="600" height="400">
                @else
                        ...
                        <div class="carousel-inner">
                            @for ($i = 0; $i < count($product->images); $i++)
                                <div class="carousel-item">
                                    <img src="{{ $product->images[$i] }}" alt="Картинка товара {{ $i + 1 }}"
        ...
        @forelse($reviews as $review)
            ...
            <div class="row flex-column broder border-bottom">
                ...
                <div class="row col">
                    <div class="row col">
                        <div class="col-1">
                            <img src="{{ $review->profilePicture }}" width="100" height="100"
                                alt="Картинка профиля">
                        </div>
                        <p class="col-2">{{ $review->name }} {{ $review->surname }}</p>
                        @if ($review->updated_at != null)
                            <p class="col-1">{{ $review->created_at }}</p>
                        @else
                            <p class="col-1">Ред. {{ $review->updated_at }}</p>
                        @endif
                        <div class="col-2">
