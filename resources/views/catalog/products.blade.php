                    ...
                    <div class="navbar-nav">
                        ...
                        @switch($sortOrder)
                            @case(App\Enum\SortOrder::NAME_ASC->value)
                                <a class="nav-link active text-black" href="{{$orderLink.App\Enum\SortOrder::NAME_DESC->value.$orderParams}}">
                                    Названию
                                    <i class="bi bi-arrow-down text-secondary"></i>
                                    <i class="bi bi-arrow-up"></i>
                                </a>
                                <a class="nav-link text-black" href="{{$orderLink.App\Enum\SortOrder::POP_DESC->value.$orderParams}}">
                                    Популярности
                                    <i class="bi bi-arrow-down text-secondary"></i>
                                    <i class="bi bi-arrow-up text-secondary"></i>
                                </a>
                                <a class="nav-link text-black" href="{{$orderLink.App\Enum\SortOrder::PRICE_DESC->value.$orderParams}}">
                                    Цене
                                    <i class="bi bi-arrow-down text-secondary"></i>
                                    <i class="bi bi-arrow-up text-secondary"></i>
                                </a>
                            ...
                            <a class="nav-link active text-black" href="{{$orderLink.App\Enum\SortOrder::NAME_ASC->value.$orderParams}}">
                                Названию
                            ...
                            @case(App\Enum\SortOrder::POP_ASC->value)
                                <a class="nav-link text-black" href="{{$orderLink.App\Enum\SortOrder::NAME_DESC->value.$orderParams}}">
                                    Названию
                                    <i class="bi bi-arrow-down text-secondary"></i>
                                    <i class="bi bi-arrow-up text-secondary"></i>
                                </a>
                                <a class="nav-link active text-black" href="{{$orderLink.App\Enum\SortOrder::POP_DESC->value.$orderParams}}">
                                    Популярности
                                    <i class="bi bi-arrow-down text-secondary"></i>
                                    <i class="bi bi-arrow-up"></i>
                                </a>
                            ...
                            @case(App\Enum\SortOrder::POP_DESC->value)
                                ...
                                <a class="nav-link active text-black" href="{{$orderLink.App\Enum\SortOrder::POP_ASC->value.$orderParams}}">
                                    Популярности
                            ...
                            @case(App\Enum\SortOrder::PRICE_ASC->value)
                                ...
                                <a class="nav-link active text-black" href="{{$orderLink.App\Enum\SortOrder::PRICE_DESC->value.$orderParams}}">
                                    Цене
                                    <i class="bi bi-arrow-down text-secondary"></i>
                                    <i class="bi bi-arrow-up"></i>
                                </a>
                            ...
                            @case(App\Enum\SortOrder::PRICE_DESC->value)
                                ...
                                <a class="nav-link active text-black" href="{{$orderLink.App\Enum\SortOrder::PRICE_ASC->value.$orderParams}}">
                                    Цене
                                    <i class="bi bi-arrow-down"></i>
                                    <i class="bi bi-arrow-up text-secondary"></i>
                                </a>
            ...
            <div class="row flex-column flex-lg-row">
                    ...
                    @foreach($products as $product)
                        <div>
                            ...
                            @if($product->images->first() == null)
                                <img src="/" alt="картинка товара" width="250" height="250">
                            @else
                                <img src="{{asset($product->images->first()->imagePath)}}" alt="картинка товара" width="250" height="250">
                            @endif
                            @php
                               $symb = Session::exists('products_currency') ? session('currency_symb') : '&#8381;';
                               switch (session('products_currency')) {
                                case 'rub':
                                    $priceStr = "Цена в рублях:";
                                    break;
                                
                                case 'dol':
                                    $priceStr = "Цена в долларах:";
                                    break;
                               }
                            @endphp
                            <p>{{$priceStr}} {{$product->priceRub}} {{$symb}}</p>
                            <div class="row">
                                <div class="col-4">
                ...
                <div class="col-12 col-lg-3 border border-1 p-3">
                    ...
                    <form action="/catalog/filter" method="POST">
                        ...
                        @if($available == 0)
                            <input type="checkbox" name="available" id="available" value="1" class="form-check"/>
                        @else
                            <input type="checkbox" name="available" id="available" value="1" class="form-check" checked />
                        @endif
