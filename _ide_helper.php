...
')
     ...
     */ 
         ...
         * @static 
         */ 
        public static function convertToDol($price)
        {
                        /** @var \App\Services\ConvertCurrencyService $instance */
                        return $instance->convertToDol($price);
        }
     ...
     *
     */ 
        class ValidatePhoneFacade {
                    /**
         * 
         *
         * @static 
         */ 
        public static function validate($phone, $message)
        {
                        /** @var \App\Services\PhoneValidationService $instance */
                        return $instance->validate($phone, $message);
        }
                    /**
         * 
         *
         * @static 
         */ 
        public static function sendCode($phone, $alreadyConfirmed)
        {
                        /** @var \App\Services\PhoneValidationService $instance */
                        return $instance->sendCode($phone, $alreadyConfirmed);
        }
                    /**
         * 
         *
        ...
        {
                        /** @var \App\Services\PhoneValidationService $instance */
                        return $instance->validateCode($code);
        }
     ...
     *
     */ 
        class ValidateEmailFacade {
                    /**
         * 
         *
         * @static 
         */ 
        public static function validate($email, $message)
        {
                        /** @var \App\Services\EmailValidationService $instance */
                        return $instance->validate($email, $message);
        }
     ...
     */ 
        ...
        {
                        /** @var \App\Services\CheckUserRoleService $instance */
                        return $instance->check($role);
        }
     ...
     *
     */ 
        class ValidatePasswordHashFacade {
                    /**
         * 
         *
         * @static 
     ...
     */ 
         ...
         * @static 
         */ 
        public static function make($name, $description, $priceRub, $stockAmount, $available, $subcategory_id, $images = null)
        {
                        /** @var \App\Services\ProductService $instance */
                        return $instance->make($name, $description, $priceRub, $stockAmount, $available, $subcategory_id, $images);
        }
                    /**
         * 
         *
         * @static 
         */ 
        public static function getFilterQuery($relationships = null, $subcategory = 'all', $product = '', $available = 1)
        {
                        /** @var \App\Services\ProductService $instance */
                        return $instance->getFilterQuery($relationships, $subcategory, $product, $available);
        }
                    /**
         * 
         *
         * @static 
         */ 
        public static function getFilterProduct($relationships, $subcategory = 'all', $product = null, $available = 1)
        {
                        /** @var \App\Services\ProductService $instance */
                        return $instance->getFilterProduct($relationships, $subcategory, $product, $available);
        }
     ...
     *
     */ 
        class ReviewServiceFacade {
                    /**
         * 
         *
         * @static 
         */ 
        public static function make($validatedInput, $userId, $productId, $images = null)
        {
                        /** @var \App\Services\ReviewService $instance */
                        return $instance->make($validatedInput, $userId, $productId, $images);
        }
                    /**
         * 
         *
         * @static 
         */ 
        public static function update($id, $validatedInput, $productId, $userId)
        {
                        /** @var \App\Services\ReviewService $instance */
                        return $instance->update($id, $validatedInput, $productId, $userId);
        }
     ...
     *
     */ 
        class ProductCartServiceFacade {
                    /**
         * 
         *
         * @static 
         */ 
        public static function convertCurrency($products)
        {
                        /** @var \App\Services\ProductCartService $instance */
                        return $instance->convertCurrency($products);
        }
                    /**
         * 
         *
         * @static 
         */ 
        public static function addProductToCart($user, $request, $amount)
        {
                        /** @var \App\Services\ProductCartService $instance */
                        return $instance->addProductToCart($user, $request, $amount);
        }
...
namespace  { 
            ...
            class ConvertCurrency extends \App\Facades\ConvertCurrencyFacade {}
            class ValidatePhone extends \App\Facades\ValidatePhoneFacade {}
            class ValidateEmail extends \App\Facades\ValidateEmailFacade {}
            class CheckUserRole extends \App\Facades\CheckUserRoleFacade {}
            class OrderItems extends \App\Facades\OrderItemsFacade {}
            class ValidatePasswordHash extends \App\Facades\ValidatePasswordHashFacade {}
            class OrderService extends \App\Facades\OrderServiceFacade {}
            class UserService extends \App\Facades\UserServiceFacade {}
            class ProductService extends \App\Facades\ProductServiceFacade {}
            class ReviewService extends \App\Facades\ReviewServiceFacade {}
            class ProductCart extends \App\Facades\ProductCartServiceFacade {}
